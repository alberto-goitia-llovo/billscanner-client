...
import { LocationStrategy, HashLocationStrategy } from '@angular/common'; //adds a # to the base URL to use hash location strategy and only send the base url to the server when reloading
